...
(eval-when-compile
  ;; these functions do not need to be loaded to compile this code
  (defun w3m-edit-current-url (&rest ignore))
  (defun w3m-copy-buffer (&rest ignore))
  (defun w3m-find-file (&rest ignore))
  (require 'font-lock))
